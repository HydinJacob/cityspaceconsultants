...
if ($subject == '') {
	$e_subject = 'Enquiry from CitySpace Website';
} 
else
{
	$e_subject = '. $subject .';
...
$e_body = "You have been contacted by $title $name from $company (Phone: $phone), their additional message is as follows." . PHP_EOL . PHP_EOL;
